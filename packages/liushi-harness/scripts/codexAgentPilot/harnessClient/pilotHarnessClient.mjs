...
export function createPilotHarnessClient(input) {
  ...
  return {
    ...
    resolveEffectiveCloseout: (sessionId, storeRoot) =>
      run(input.consumerRoot, [
        "coding-task",
        "session",
        "closeout",
    ...
    completeSession: (completionFile, sessionId, repositoryRoot, actorId, storeRoot) =>
      run(input.consumerRoot, [
        "coding-task",
        "session",
        "complete",
    ...
    settleMetrics: (file, sessionId, actorId, storeRoot) =>
      run(input.consumerRoot, [
        "coding-task",
        "session",
        "metrics",
