...
- CodingTask Domain Core 已提供单仓 Aggregate、独立 Schema、ExecutionAuthorization、G2 历史逻辑确认绑定、Attempt 串行状态机、Verification 结果接纳和 Human Resolution；该切片仍不包含 Store、Command、Worktree 或真实 Executor。
