...
| 08 Executor Adapter         | 已完成   | `partial`     | Codex Probe、Hook Binding、Pre/Post Adapter、CLI Wrapper、`hooks.json` 投影、Fixture 测试和固定公开项目生产 CLI Cell Smoke                                                                                                                                                                                                                                            | Codex Host Hook Smoke、安装协议、Claude/CatPaw Adapter、Role Invocation                                                         |
...
| 14 生产 SOP                 | 已完成   | `partial`     | npm、Tarball 干净安装 Smoke、ESM/CJS、双 CLI Bin、Doctor、Task、Artifact、Approval、Rule、Scanner、Profile Compile、Codex Probe、固定公开项目 Cell 证据                                                                                                                                                                                                               | 企业项目安装、自动 Task Delivery、Executor、Workflow、Memory、Learning 和长期治理命令                                           |
