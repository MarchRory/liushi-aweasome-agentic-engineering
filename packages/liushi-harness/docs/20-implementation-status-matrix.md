...
因此，表格中 CodingTask Store/Command 的旧描述以本节为准；Worktree 创建/管理、Repository Lock、受控写入、Action Journal 接入、真实 Verification Command Runner、影响面选择、重试/Flaky、Waiver、多仓编排和 Studio 仍未实现。
