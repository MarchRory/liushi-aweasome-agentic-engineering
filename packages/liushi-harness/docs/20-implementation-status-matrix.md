...
| 08 Executor Adapter         | 已完成   | `partial`     | Codex Probe、Hook Binding、Pre/Post Adapter、CLI Wrapper、`hooks.json` 投影、Fixture 测试、固定公开项目生产 CLI Cell Smoke 和默认只读 Host Smoke Prepare                                                                                                                                                                                                              | Codex Host Hook 真实正负路径、安装协议、Claude/CatPaw Adapter、Role Invocation                                                  |
...
| 14 生产 SOP                 | 已完成   | `partial`     | npm、Tarball 干净安装 Smoke、ESM/CJS、双 CLI Bin、Doctor、Task、Artifact、Approval、Rule、Scanner、Profile Compile、Codex Probe、固定公开项目 Cell 证据和 Host Smoke Prepare                                                                                                                                                                                          | 企业项目安装、真实 Host 激活、自动 Task Delivery、Executor、Workflow、Memory、Learning 和长期治理命令                           |
...
因此，表格中 CodingTask Store/Command 的旧描述以本节为准；固定公开项目的预编排 Mutation CLI 正路径已有历史验证快照，但 Worktree 清理/重建、Import Graph、重试/Flaky、Waiver、多仓影响传播、真实 Agent 编码、Codex Host Hook 生产验证和 Studio 仍未实现。
...
- Codex Host Hook 在真实受信任项目的正负路径、自动安装、Claude-compatible 或 CatPaw Adapter。
