...
- 完整 Codex Agent Host：当前已完成 Runtime Isolation、Session Flags 与 App Server Runner；零模型 Preflight 和 Application Host 生命周期仍未实现。
