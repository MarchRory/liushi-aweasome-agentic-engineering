...
- Closeout CLI、显式恢复命令/恢复 SOP 自动化、S3 Closeout 真实 Git E2E、Submission/Verification/PRReady 串联、真实 Codex Pilot 和多仓交付。
