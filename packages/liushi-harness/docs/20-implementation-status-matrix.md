...
| 08 Executor Adapter         | 已完成   | `partial`     | Codex Probe、Hook Binding、Pre/Post Adapter、CLI Wrapper、`hooks.json` 投影、Fixture 测试、固定公开项目生产 CLI Cell Smoke，以及 Windows/Codex `0.144.0-alpha.4` 交互式 TUI 的同会话 Host 正负路径                                                                                                                                                                    | 安装协议、Codex 版本/平台矩阵、Claude/CatPaw Adapter、Role Invocation                                                           |
...
| 14 生产 SOP                 | 已完成   | `partial`     | npm、Tarball 干净安装 Smoke、ESM/CJS、双 CLI Bin、Doctor、Task、Artifact、Approval、Rule、Scanner、Profile Compile、Codex Probe、固定公开项目 Cell 证据，以及交互式 Host Smoke Prepare/Result Gate                                                                                                                                                                    | 企业项目安装、自动 Host 激活、自动 Task Delivery、Executor、Workflow、Memory、Learning 和长期治理命令                           |
...
- Codex Host Hook 自动安装、其他工具/版本/平台验证、Claude-compatible 或 CatPaw Adapter。
