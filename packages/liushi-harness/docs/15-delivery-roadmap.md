...
Closeout Recovery 已完成第一阶段只读能力：三态 Checkpoint Assessment、原 Closeout Command 与权威身份复验、fresh Snapshot 漂移检查、唯一 `RetryOnce`/`BindExisting` Resolution 以及 canonical Assessment Digest。该能力不写 Recovery State、不获取 Repository Lock、不执行 Checkpoint，也不代表 Human-gated 恢复闭环完成。
