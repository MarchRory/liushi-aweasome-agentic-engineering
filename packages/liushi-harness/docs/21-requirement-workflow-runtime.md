...
| S3 CodingTask 与 Verification | CodingTask Domain Core、独立 Schema、ExecutionAuthorization、Attempt/Verification 状态机、Human Resolution | Store/Command、Worktree、Action Journal 接入、Mock Executor、EvidenceBundle；崩溃可恢复、环境失败不进入 Bug Fix、需求歧义返回 Human                                |
