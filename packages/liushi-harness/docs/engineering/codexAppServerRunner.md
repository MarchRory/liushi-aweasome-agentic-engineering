...
Session Flags 与零模型 Preflight 已作为独立 Agent Host Infrastructure 模块完成正式化；Runner 仍只负责 App Server 协议、进程生命周期和 File Change Approval，不吸收 Session Flags、Preflight 或 Application Host 生命周期。
